...
class _DetailAnnounceState extends State<DetailAnnounce> {
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 20),
                      Text(
                        "${announcement.dateCreated!.day}/${announcement.dateCreated!.month}/${announcement.dateCreated!.year}",
                        style: TextStyle(fontSize: 20),
                      ),
                    ],
                  ),
  ...
  Future<void> getAnnouncement() async {
    String? key = Provider.of<LoginProvider>(context, listen: false).key;
    ...
    try {
      ...
      Response response = await http.getRequest(
          "${http.baseUrl}Announcement/GetAnnouncementById?annId=$key");

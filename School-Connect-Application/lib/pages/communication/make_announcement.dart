...
class MakeSchoolAnnouncementPage extends StatefulWidget {
  ...
  State<MakeSchoolAnnouncementPage> createState() =>
      _SchoolAnnouncementPageState();
}

class _SchoolAnnouncementPageState extends State<MakeSchoolAnnouncementPage> {
          ...
          child: Column(
            ...
            children: [
              ...
              StyledFormField(
                ...
                dropdownItems: [
                  if (principal.principalSchoolNP?.type == 'Primary') ...[
                    "All Parents",
                    "Grade 1",
                    "Grade 2",
                    "Grade 3",
                    ...
                    "Grade 6",
                    "Grade 7",
                  ] else if (principal.principalSchoolNP?.type == 'High') ...[
                    "All Parents",
                    "Grade 8",
                    "Grade 9",
                    "Grade 10",
                    "Grade 11",
                    "Grade 12"
                  ] else if (principal.principalSchoolNP?.type ==
                      'Combined') ...[
                    "All Parents",
                    "Grade 1",
                    "Grade 2",
